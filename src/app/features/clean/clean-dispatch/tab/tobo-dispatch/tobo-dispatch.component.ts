...
@Component({
  selector: 'app-tobo-dispatch',
  templateUrl: './tobo-dispatch.component.html',
  styleUrls: ['./tobo-dispatch.component.scss']
})
export class ToboDispatchComponent implements OnInit {
